...
portal.on('COMPONENT_SEGMENT_LOADED.a3246c06-0d15-41f0-a52e-4683be4ff47f', function (e) {
  (function ($) {
    'use strict';
    ...
    $.widget('hie.inputMask', {
      ...
      _renderInputMaskInfo: function _renderInputMaskInfo() {
        var _self = this;
        var inputVal;
        var maskVal;
        var startPosition;
      ...
      _getMaskCharacter: function _getMaskCharacter() {
        var _self = this;
      ...
      alignCursor: function alignCursor() {
        this.mask.alignCursor();
      },
      setSelectionPos: function setSelectionPos() {
