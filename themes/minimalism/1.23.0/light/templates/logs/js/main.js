...
$('.latest-status-info').tooltip({
  title: `In BCC mode and SPAN/TAP mode, mirrored traffic is used to monitor your network, and replicated email messages are discarded without delivery.`,
