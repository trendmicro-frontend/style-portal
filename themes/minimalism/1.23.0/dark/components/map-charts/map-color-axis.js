    ...
    $(function () {
        ...
        var mapColorAxis = HighMap.mapChart('map-color-axis-chart-container', {
            ...
            legend: {
                ...
                valueDecimals: 0,
                itemMarginBottom: 14,
                itemStyle: { 'color': '#bbbbbb', 'fontWeight': 'normal', 'fontSize': '13px' },
                ...
                backgroundColor: HighMap.defaultOptions && HighMap.defaultOptions.legend && HighMap.defaultOptions.legend.backgroundColor || '#2c2c2c',
                symbolHeight: 8,
                symbolPadding: 0
